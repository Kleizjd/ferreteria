    ...
    <div class="card card-login mx-auto mt-5">
      ...
      <div class="card-body">
        <div class="text-center mb-4">
          ...
          <p>Ingresa tu correo electronicao y te enviaremos instrucciones para restablacer tu contrasena.</p>
        </div>
        <form>
        ...
        <div class="text-center">
          ...
          <a class="d-block small" href="login.html">Pagina de Ingreso</a>
        </div>
      </div>
    </div>
  </div>
